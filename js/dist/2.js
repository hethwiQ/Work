    ...
    188: (e, t, s) => {
            ...
            for (let s = 0, i = e.length; s < i; s += 1) {
              ...
              void 0 !== n &&
                ...
                (C(t[i]) && C(r[i])
                  ...
                  : !C(t[i]) && C(r[i])
                  ? ((t[i] = {}),
                    r[i].__swiper__ ? (t[i] = r[i]) : T(t[i], r[i]))
                  : (t[i] = r[i]));
            }
          }
        }
      ...
      function ne({ swiper: e, extendParams: t, on: s, emit: i }) {
        ...
        function d() {
          ...
          if (
            ("fraction" === s.type &&
              (d.find(ie(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
              d.find(ie(s.totalClass)).text(s.formatFractionTotal(p))),
            "progressbar" === s.type)
          ) {
            let t;
        ...
        function c() {
          ...
          if ("bullets" === t.type) {
            ...
            n.html(r), (e.pagination.bullets = n.find(ie(t.bulletClass)));
          }
          "fraction" === t.type &&
            ((r = t.renderFraction
        ...
        function p() {
          ...
          0 !== s.length &&
            ...
            t.clickable &&
              s.on("click", ie(t.bulletClass), function (t) {
                t.preventDefault();
        ...
        function u() {
          ...
          s.removeClass(t.hiddenClass),
            ...
            t.clickable && s.off("click", ie(t.bulletClass));
        }
        s("init", () => {
      ...
      function re({ swiper: e, extendParams: t, on: s }) {
        ...
        function r() {
          ...
          if (
            ((n = t.params.loop
              ? parseInt(g(t.clickedSlide).attr("data-swiper-slide-index"), 10)
              : s),
            e.params.loop)
          ) {
            let t = e.activeIndex;
